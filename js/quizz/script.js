...
var quizController = (function() {
    ...
    // 305
    var adminFullName = ['layuss', 'layuss'];
    // 282
    ...
    return {
        ...
        newDesign: function(ansResult, selectedAnswer) {
            ...
            twoOptions = {
                ...
                // 258
                emotionType: ['/images/quizz/sad.png', '/images/quizz/happy.png'],
                // 261
        ...
        finalResult: function(currPerson) {
            // 334
            domItems.finalScoreText.textContent = currPerson.fullname[0] + ' ' + currPerson.fullname[1] + ', ' + 'your final score is ' + currPerson.score + '/40 ' ;
            // 336
